...
function Contacts() {
  ...
  return (
    <div className='contact-container'>
      <div className='title-contact' data-aos="fade-down" data-aos-duration="3000">Contact Me</div>
      <div className='page' id='Contact' data-aos="zoom-in" data-aos-duration="3000">
